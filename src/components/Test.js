...
//import assets
import sky from '../assets/test1.jpg'
...
const Test = () => {
    ...
    return (
        <a-scene inspector>
            ...
            <a-light type="point" color="#F2F4CB" position="147 70 0" intensity="0.5"></a-light>
            <a-light type="point" color="#F2F4CB" position="0 70 -127.5" intensity="0.5"></a-light>
            <a-light type="point" color="#F2F4CB" position="0 70 170"></a-light>
        </a-scene>
    )
}
